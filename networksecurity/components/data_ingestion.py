...
class DataIngestion:
    def __init__(self,data_ingestion_config:DataIngestionConfig):
        try:
            ...
            self.logging = logger_function('DataIngestion')
    ...
    def export_collection_as_dataframe(self):
        ...
        try:
            ...
            collection=self.mongo_client[collection_name][database_name]
    ...
    def split_data_as_train_test(self,dataframe: pd.DataFrame):
        try:
            ...
            self.logging.info("Exited split_data_as_train_test method of Data_Ingestion class")
...
if __name__=='__main__':
    ...
    def test():
        try:
            ...
            self.logging.error(f"Error occurred during data ingestion: {str(e)}")
            sys.exit(1)
